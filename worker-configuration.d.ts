/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cd020501c2be799aab05ca87817a1a02)
// Runtime types generated with workerd@1.20250416.0 2025-04-08 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		AUTO_RAG_NAME: string;
		MCP_OBJECT: DurableObjectNamespace<import("./worker/index").GitHubStarsMCP>;
		AI: Ai;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTO_RAG_NAME">> {}
}
